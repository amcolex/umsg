...
umsg_queue_handle_t umsg_battery_state_subscribe(uint32_t prescaler, uint8_t length);
void umsg_battery_state_publish(umsg_battery_state_t* data);
uint8_t umsg_battery_state_receive(umsg_queue_handle_t queue, umsg_battery_state_t* data, uint32_t timeout);
